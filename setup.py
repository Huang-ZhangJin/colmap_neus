...
__version__ = None
exec(open("cneus/version.py", "r").read())
...
setup(
    name="cneus",
    version=__version__,
    author="Zhangjin Huang",
    author_email="eehuangzhangjin@mail.scut.edu.cn",
    description="NeuS surface reconstruction from Images/Video",
    long_description="NeuS surface reconstruction from Images/Video",
    packages=find_packages(),
    ext_modules=[CMakeExtension(name="cneus.libcneus")],
